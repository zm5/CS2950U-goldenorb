...
public class OrbRunnerTest extends OrbRunner {
  ...
  public void testDistributeFiles() throws IOException, KeeperException, InterruptedException, OrbZKFailure {
    ...
    assertTrue(fs.exists(new Path("/users/goldenorb/DistributeFiles/distributeTest1.txt")));
    assertTrue(fs.exists(new Path("/users/goldenorb/DistributeFiles/distributeTest2.txt")));
    assertTrue(fs.exists(new Path("/users/goldenorb/DistributeFiles/HelloWorld.jar")));
